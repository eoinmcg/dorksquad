...
var _Dude = __webpack_require__(/*! ../sprites/Dude */ 343);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function preload() {
      _phaser2.default.Canvas.setSmoothingEnabled(this.game.context, false);
    ...
    key: 'addDudes',
    value: function addDudes() {
      var dudes = this.game.add.group();
      dudes.enableBody = true;
      dudes.physicsBodyType = _phaser2.default.Physics.ARCADE;
      return dudes;
    }
  }, {
    key: 'addDude',
    value: function addDude() {
      var num = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;

      var dudeData = [{ name: 'dude', x: this.world.centerX + 20, y: this.world.centerY - 20 }, { name: 'unicorn', x: this.world.centerX - 20, y: this.world.centerY - 20 }];
      var dude = new _Dude2.default({
        p: this,
    ...
    key: 'addBaddies',
    value: function addBaddies() {
      var baddies = this.game.add.group();
      baddies.enableBody = true;
      baddies.physicsBodyType = _phaser2.default.Physics.ARCADE;
      return baddies;
    }
  }, {
    key: 'addPowerups',
    value: function addPowerups() {
      var powerups = this.game.add.group();
      powerups.enableBody = true;
      powerups.physicsBodyType = _phaser2.default.Physics.ARCADE;
      return powerups;
    }
  }, {
    key: 'addKittens',
    value: function addKittens() {
      var kittens = this.game.add.group();
      kittens.enableBody = true;
      kittens.physicsBodyType = _phaser2.default.Physics.ARCADE;
      return kittens;
    }
  }, {
    key: 'addBullets',
    ...
    key: 'addBooms',
    value: function addBooms() {
      var booms = this.game.add.group();
...
/* global Phaser */
var padZeros = function padZeros(num) {
  var zeros = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 6;
...
var outOfArena = function outOfArena(x, y) {
  return x < 8 || x > 160 - 8 || y < 20 || y > 180;
};

var randomDoor = function randomDoor() {
  var maxX = 156;
  var maxY = 180;
  var points = [[8, maxY / 4 * 1], [8, maxY / 4 * 3], [maxX - 8, maxY / 4 * 1], [maxX - 8, maxY / 4 * 3], [maxX / 2, 16]];
  return points[Math.floor(Math.random() * points.length)];
};

var randomPos = function randomPos() {
  return [Math.floor(Math.random() * (156 - 12)) + 12, Math.floor(Math.random() * (180 - 24)) + 24];
};
...
var controls = function controls(keys, pad) {
  var vy = 0;
  var vx = 0;
  var dir = false;
  var fire = false;

  if (keys.up.isDown || pad.isDown(Phaser.Gamepad.XBOX360_DPAD_UP) || pad.axis(Phaser.Gamepad.XBOX360_STICK_LEFT_Y) < -0.1) {
    vy = -1;
    dir = 'up';
  }
  if (keys.down.isDown || pad.isDown(Phaser.Gamepad.XBOX360_DPAD_DOWN) || pad.axis(Phaser.Gamepad.XBOX360_STICK_LEFT_Y) > 0.1) {
    vy = 1;
    dir = 'down';
  }
  if (keys.left.isDown || pad.isDown(Phaser.Gamepad.XBOX360_DPAD_LEFT) || pad.axis(Phaser.Gamepad.XBOX360_STICK_LEFT_X) < -0.1) {
    vx = -1;
    dir = 'left';
  }
  if (keys.right.isDown || pad.isDown(Phaser.Gamepad.XBOX360_DPAD_RIGHT) || pad.axis(Phaser.Gamepad.XBOX360_STICK_LEFT_X) > 0.1) {
    vx = 1;
    dir = 'right';
  }
  ...
  return { dir: dir, vx: vx, vy: vy, fire: fire };
};

exports.padZeros = padZeros;
exports.outOfArena = outOfArena;
exports.randomDoor = randomDoor;
...
module.exports = __webpack_require__(/*! /home/eoin/www/phaser/throwback/src/main.js */332);
...
var _Loading = __webpack_require__(/*! ./states/Loading */ 338);
...
var _Title = __webpack_require__(/*! ./states/Title */ 341);

var _Title2 = _interopRequireDefault(_Title);

var _Play = __webpack_require__(/*! ./states/Play */ 342);

var _Play2 = _interopRequireDefault(_Play);

var _Credits = __webpack_require__(/*! ./states/Credits */ 348);

var _Credits2 = _interopRequireDefault(_Credits);

var _Help = __webpack_require__(/*! ./states/Help */ 353);
...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, width, height, _phaser2.default.CANVAS, 'content', null, true, false));

    _this.state.add('Boot', _Boot2.default, false);
    _this.state.add('Loading', _Loading2.default, false);
    ...
    _this.state.add('Help', _Help2.default, false);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'preload',
    value: function preload() {
      var text = this.add.text(this.world.centerX, this.world.centerY, 'LOADING', { font: '16px Arial', fill: '#ff0', align: 'center' });
      ...
      this.load.tilemap('level1', 'a/maps/level1.json', null, _phaser2.default.Tilemap.TILED_JSON);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.keys = {
        k1: this.game.input.keyboard.addKey(_phaser2.default.Keyboard.ONE),
        k2: this.game.input.keyboard.addKey(_phaser2.default.Keyboard.TWO),
        c: this.game.input.keyboard.addKey(_phaser2.default.Keyboard.C),
        h: this.game.input.keyboard.addKey(_phaser2.default.Keyboard.H)
      };
    }
  }, {
    key: 'update',
    value: function update() {
      ...
      if (this.spaceKey.isDown || this.pad.justPressed(_phaser2.default.Gamepad.XBOX360_A)) {
        this.startGame();
      }
    }
  }, {
...
var _BaseGame2 = __webpack_require__(/*! ./BaseGame */ 91);

var _BaseGame3 = _interopRequireDefault(_BaseGame2);

var _Baddie = __webpack_require__(/*! ../sprites/Baddie */ 344);

var _Baddie2 = _interopRequireDefault(_Baddie);

var _Kitten = __webpack_require__(/*! ../sprites/Kitten */ 346);

var _Kitten2 = _interopRequireDefault(_Kitten);

var _Powerup = __webpack_require__(/*! ../sprites/Powerup */ 347);

var _Powerup2 = _interopRequireDefault(_Powerup);

var _helpers = __webpack_require__(/*! ../helpers */ 92);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* global Phaser */


var _class = function (_BaseGame) {
  _inherits(_class, _BaseGame);
  ...
  _createClass(_class, [{
    ...
    value: function init() {
      ...
      this.spawnTime = 100;
      this.wave = 1;
      var plays = parseInt(sessionStorage.getItem('plays'), 10) || 0;
    ...
    value: function create() {
      ...
      this.baddies = _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addBaddies', this).call(this);
      this.bullets = _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addBullets', this).call(this);
      this.dudes = _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addDudes', this).call(this);
      this.powerups = _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addPowerups', this).call(this);
      this.kittens = _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addKittens', this).call(this);
      this.flash = _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addFlash', this).call(this);
      this.booms = _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addBooms', this).call(this);
      this.emitter = _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'addEmitter', this).call(this);
      ...
      this.kittens.add(new _Kitten2.default({ game: this.game, p: this }));
      this.keys = {
      ...
      this.game.time.events.add(Phaser.Timer.SECOND * 10, function () {
        _this2.spawnTime = _this2.spawnTime / 2;
      }, this);
    }
  }, {
    key: 'update',
    value: function update() {
      ...
      this.bullets.forEachAlive(function (b) {
        if ((0, _helpers.outOfArena)(b.x, b.y)) {
          _this3.particleBurst(b.x, b.y);
          b.kill();
        }
      });
      ...
      var collision = this.game.physics.arcade;
      ...
      this.p1Score.text = (0, _helpers.padZeros)(this.dude.score);
      if (this.p2Score) {
        this.p2Score.text = (0, _helpers.padZeros)(this.unicorn.score);
      }
    }
  }, {
    key: 'render',
    ...
    key: 'baddieHitDude',
    value: function baddieHitDude(baddie, dude) {
      var _this4 = this;
      ...
      if (dudesLeft.length === 0 && !this.gameOver) {
        ...
        this.game.time.events.add(Phaser.Timer.SECOND * 10, function () {
          _this4.state.start('Title');
        }, this);

        this.game.add.tween(this.text).to({ y: this.game.world.height / 2 }, 1000, Phaser.Easing.None).start();
        ...
        if (this.p2Score) {
          ...
          this.game.add.tween(this.winner).to({ y: this.game.world.height - 25 }, 1000, Phaser.Easing.None).start();
        }
      }
    }
  }, {
    key: 'dudeHitPowerup',
    value: function dudeHitPowerup(dude, powerup) {
      powerup.receiveDamage(dude);
    }
  }, {
    key: 'dudeHitKitten',
    value: function dudeHitKitten(dude, kitten) {
      kitten.kill();
      var type = Math.random() > 0.5 ? 'bullet' : 'boot';
    ...
    key: 'bulletHitBaddie',
    value: function bulletHitBaddie(bullet, baddie) {
    ...
    key: 'bulletHitKitten',
    value: function bulletHitKitten(bullet, kitten) {
      bullet.kill();
      this.particleBurst(bullet.x, bullet.y);
    ...
    key: 'spawnBullet',
    value: function spawnBullet(x, y, vx, vy, owner) {
      var bullet = this.bullets.getFirstExists(false);
      bullet.name = 'bullet';
      bullet.owner = owner;
      bullet.reset(x, y);

      var flash = this.flash.getFirstExists(false) || this.flash.getFirstAlive();
    ...
    key: 'spawnBaddie',
    value: function spawnBaddie() {
      var time = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.spawnTime;

      if (this.spawnTime < 50) this.spawnTime = 50;
      this.nextSpawn = Math.floor(Math.random() * this.spawnTime) + this.spawnTime;
      var dudes = this.getDudes();
      ...
      this.baddies.add(new _Baddie2.default({
        game: this.game,
        p: this,
        type: false
      }));
    ...
    key: 'spawnPowerup',
    value: function spawnPowerup(x, y, type) {
      if ((0, _helpers.outOfArena)(x, y)) return;
      this.powerups.add(new _Powerup2.default({
        game: this.game,
        p: this,
        x: x,
        y: y,
    ...
    key: 'claimKill',
    value: function claimKill(owner) {
      if (owner === 'dude') {
        this.dude.score += 5;
    ...
    key: 'killEmAll',
    value: function killEmAll(x, y) {
      this.makeBoom(x, y, 5);
      this.baddies.forEachAlive(function (baddie) {
        baddie.explode();
      });
    }
  }, {
    key: 'particleBurst',
    value: function particleBurst(x, y, particles) {
      this.emitter.x = x;
      this.emitter.y = y;
    ...
    key: 'makeBoom',
    value: function makeBoom(x, y) {
      var scale = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;

      var boom = this.booms.getFirstExists(false) || this.booms.getFirstAlive();
      var g = this.game;
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, p.game, x, y, 'dude'));

    _this.scale.setTo(scale, scale);
    _this.p = p;
    _this.game.physics.enable(_this, _phaser2.default.Physics.ARCADE);
    _this.collideWorldBounds = true;
    ...
    var animOffset = _this.name === 'dude' ? 0 : 10;
    for (var n in anims) {
      var i = anims[n].length;
      while (i--) {
        anims[n][i] += animOffset;
      }
    }

    _this.animations.add('idle', anims.idle, 10, true);
    _this.animations.add('idle_up', anims.idle_up, 10, true);
    _this.animations.add('idle_down', anims.idle_down, 10, true);
    _this.animations.add('left', anims.left, 10, true);
    _this.animations.add('right', anims.right, 10, true);
    _this.animations.add('up', anims.up, 10, true);
    _this.animations.add('down', anims.down, 10, true);
    _this.animations.play('idle');
    _this.vx = 1;
    _this.vy = 0;
    _this.facing = { x: _this.vx, y: _this.vy };
    _this.dir = 'left';
    _this.bulletDelay = 2;
    ...
    if (_this.name === 'dude') {
      ...
      _this.keys = {
        shoot: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.SHIFT),
        up: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.UP),
        down: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.DOWN),
        left: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.LEFT),
        right: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.RIGHT)
      };
    } else {
      _this.pad = _this.game.input.gamepad['pad2'];
      _this.keys = {
        shoot: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.R),
        up: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.W),
        down: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.S),
        left: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.A),
        right: _this.game.input.keyboard.addKey(_phaser2.default.Keyboard.D)
      };
    }
    return _this;
  }
  ...
  _createClass(_class, [{
    ...
    value: function update() {
      var pad = this.pad;
      this.bulletDelay = this.bulletDelay > 0 ? this.bulletDelay - 1 : 0;

      var input = (0, _helpers.controls)(this.keys, pad);
      ...
      if (this.vx === 0 && this.vy === 0) {
        var animDir = this.dir !== 'left' && this.dir !== 'right' ? '_' + this.dir : '';
    ...
    key: 'consumePowerup',
    value: function consumePowerup(name) {
      if (name === 'donut') {
        this.score += 20;
      } else if (name === 'boot') {
...
var _data = __webpack_require__(/*! ../data */ 345);
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, 0, 0, 'baddies'));

    _this.p = p;
    var pos = (0, _helpers.randomDoor)();
    _this.baddie = _this.getData(type);
    _this.health = _this.baddie.health;
    _this.position.x = pos[0];
    _this.position.y = pos[1];
    _this.scale.setTo(_this.baddie.scale, _this.baddie.scale);
    _this.anchor.setTo(0.5, 0.5);
    _this.game.physics.enable(_this, _phaser2.default.Physics.ARCADE);
    _this.speed = _this.baddie.speed;

    _this.animations.add('idle', _this.baddie.idle, 8, true);
    _this.animations.add('walk', _this.baddie.walk, 8, true);
    _this.animations.add('kill', _this.baddie.kill, 5, false);

    _this.animations.play('walk');
    _this.dude = _this.findDude();
  ...
  _createClass(_class, [{
    key: 'findDude',
    value: function findDude() {
      var dudes = this.p.getDudes();
      return dudes[Math.floor(Math.random() * dudes.length)];
    }
  }, {
    key: 'killDude',
    value: function killDude() {
      var _this2 = this;

      this.animations.play('kill');
      this.animations.currentAnim.onComplete.add(function () {
        _this2.dude = _this2.findDude();
        _this2.animations.play(_this2.dude ? 'walk' : 'idle');
      });
    }
  }, {
    key: 'receiveDamage',
    ...
    value: function explode(o) {
      ...
      if (Math.random() > this.baddie.powerupFreq) {
        this.p.spawnPowerup(~~this.x, ~~this.y, (0, _helpers.randomItem)(this.baddie.powerups));
      }
      this.kill();
    }
  }, {
    ...
    value: function update() {
      ...
      var dudePos = this.dude.position;
    ...
    value: function getData(type) {
      if (!type) {
        var types = Object.keys(_data2.default.baddies);
        type = types[Math.floor(Math.random() * types.length)];
      }
      var baddie = _data2.default.baddies[type];
      baddie.name = type;
      return baddie;
    }
  }]);
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, 0, 0, 'kitten'));
    ...
    _this.animations.add('idle', [0], 8, true);
    _this.animations.add('walk', [1, 2], 8, true);
    _this.animations.add('dead', [3], 8, true);
    _this.startMoving();
    _this.isShot = false;
    return _this;
  }
  ...
  _createClass(_class, [{
    ...
    value: function update() {
      ...
      var lost = this.x < 8 || this.x > 150 || this.y < 24 || this.y > 180;
      var arrived = this.to[0] === ~~this.position.x && this.to[1] === ~~this.position.y;
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, 0, 0, 'powerups'));
    ...
    _this.types = ['coin', 'donut', 'bomb', 'bullet', 'boot'];
    if (!type) {
      type = _this.types[Math.floor(Math.random() * _this.types.length)];
    }

    _this.animations.add('coin', [0], 8, true);
    _this.animations.add('donut', [1], 8, true);
    _this.animations.add('bomb', [2], 8, true);
    _this.animations.add('bullet', [3], 8, true);
    _this.animations.add('boot', [4], 8, true);

    _this.animations.play(type);
  ...
  _createClass(_class, [{
    ...
    value: function receiveDamage(o) {
      ...
      tween.to({ x: o.name === 'dude' ? 0 : this.game.world.width, y: 20 }, 400, _phaser2.default.Easing.None);
      tween.start();
...
var _class = function (_BaseGame) {
  ...
  _createClass(_class, [{
    key: 'create',
    value: function create() {
      var text = this.game.add.bitmapText(0, 0, 'cpc464', this.text(), 8);
...
var _class = function (_BaseGame) {
  ...
  _createClass(_class, [{
    key: 'preload',
    value: function preload() {
      _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'preload', this).call(this);
    }
  }, {
    key: 'create',
    value: function create() {
